...
```
kubectl autoscale deploy promotion --min=1 --max=10 --cpu-percent=15
```
![오토스케일설정](https://user-images.githubusercontent.com/69283816/97519750-15414d00-19dd-11eb-8816-e42dca1ac4cd.png)

- 워크로드를 걸어준다.
```
siege -c200 -t120S   --content-type "application/json" 'http://promotion:8080/promotions POST  {"reserveStatus":"reserve","reservationNumber":1,"status":"promotion"}'
```
...
- 새버전으로의 배포 시작
```
kubectl set image deploy promotion promotion=team04acrpark.azurecr.io/promotion:latest
```
...
![desc1](https://user-images.githubusercontent.com/69283816/97531052-b4bf0980-19f6-11eb-8951-f6a372486bdf.png)
